...
#       initialize()
#       update()
#       read_config_file()           ####  not finished yet  ####
...
##    case_prefix = 'Test1'
    ...
    d8.initialize(directory=directory,
...
#   unit_test()
#---------------------------------------------------------------------
class d8_component(CSDMS_base.CSDMS_component):

    def __init__(self):

        # print "Instantiating d8_base component..."
    ...
    def get_output_items(self):
        ...
        items = ['ID_grid', 'flow_grid', 'A', 'ds', 'dw',
                 'parent_IDs', 'edge_IDs', 'noflow_IDs',
    ...
    def initialize(self, directory=None,
        ...
        #--------------------------------------------------
        # Not finished yet, but gives more usage options.
        #--------------------------------------------------
...
##            self.DONE   = True
    ...
    def initialize_ports(self):
        ...
        if (self.ep.get_status() != 'initialized'):        # erosion vars
            self.ep.initialize(directory=self.directory,
...
##            file_unit.close()
    ...
    def start_new_flow_grid(self, DEM=None, SILENT=True, REPORT=False):
        ...
        #---------------------------------------------------------
        if (DEM == None):
            dp = (self.directory + self.data_prefix)
...
##                a7 = numpy.roll(self.A, 1, axis=0)                          # (top)
        ...
        #-------------------------------------------------
        if (self.DEBUG):
            area_file = (self.directory +
                         self.data_prefix + '_area.rtg')
