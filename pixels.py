...
def unit_test():
    ...
    directory   = '/Applications/RIVIX/RiverTools_3.0/basins/KY_Sub/'
    data_prefix = 'KY_Sub'
    RTI_file    = (directory + data_prefix + '.rti')
    ...
    directory   = '/Applications/RIVIX/RiverTools_3.0/basins/Beaver_Creek_KY/'
    data_prefix = 'Beaver'
    RTI_file    = (directory + data_prefix + '.rti')
    info = rti_files.read_info( RTI_file, REPORT=True )
    da   = get_da(info, REPORT=True, VERBOSE=True)
