...
#   TF_Build_Date()
#-------------------------------------------------------------------
def TF_Version():    #, TITLE_BAR=title_bar

    date_str   = '(' + TF_Build_Date() + ')'
    # title_bar  = 'TopoFlow 3.0 beta Dialog  ' + date_str
    ver_string = 'TopoFlow Version 3.0 beta ' + date_str
